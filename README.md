...
- 🎯 Entry points to execute your program using `python -m <learn_fastapi>` or `$ learn_fastapi` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/shubham1809/learn_fastapi/branch/main/graph/badge.svg?token=learn_fastapi_token_here)](https://codecov.io/gh/shubham1809/learn_fastapi)
[![CI](https://github.com/shubham1809/learn_fastapi/actions/workflows/main.yml/badge.svg)](https://github.com/shubham1809/learn_fastapi/actions/workflows/main.yml)

Awesome learn_fastapi created by shubham1809

## Install

from source
```bash
git clone https://github.com/shubham1809/learn_fastapi learn_fastapi
cd learn_fastapi
make install
```
...
```bash
pip install learn_fastapi
```

## Executing

```bash
$ learn_fastapi run --port 8080
```

or

```bash
python -m learn_fastapi run --port 8080
```

or

```bash
$ uvicorn learn_fastapi:app
```
...
```bash
❯ learn_fastapi --help
Usage: learn_fastapi [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ learn_fastapi create-user --help
Usage: learn_fastapi create-user [OPTIONS] USERNAME PASSWORD
...
```bash
learn_fastapi create-user admin admin --superuser
```
...
Run with `learn_fastapi run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `learn_fastapi create-user`.
...
-----------------------------------------------------
learn_fastapi/__init__.py              4      0   100%
learn_fastapi/app.py                  16      1    94%
learn_fastapi/cli.py                  21      0   100%
learn_fastapi/config.py                5      0   100%
learn_fastapi/db.py                   10      0   100%
learn_fastapi/models/__init__.py       0      0   100%
learn_fastapi/models/content.py       47      1    98%
learn_fastapi/routes/__init__.py      11      0   100%
learn_fastapi/routes/content.py       52     25    52%
learn_fastapi/routes/security.py      15      1    93%
learn_fastapi/routes/user.py          52     26    50%
learn_fastapi/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
```py
from learn_fastapi.config import settings
```
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in learn_fastapi/default.toml.

### As environment variables
```bash
export learn_fastapi_KEY=value
export learn_fastapi_KEY="@int 42"
export learn_fastapi_KEY="@jinja {{ this.db.uri }}"
export learn_fastapi_DB__uri="@jinja {{ this.db.uri | replace('db', 'data') }}"
```
...
```bash
learn_fastapi_ENV=production learn_fastapi run
```
