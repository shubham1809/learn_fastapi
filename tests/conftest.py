...
# WARNING: Ensure imports from `learn_fastapi` comes after this line
from learn_fastapi import app, settings, db  # noqa
from learn_fastapi.cli import create_user, cli  # noqa
